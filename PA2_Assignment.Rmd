...
cleanStormDat <- function(stormDat){        ## Function makes data "tidier."
  ...
  stormDat[stormDat$state == "XX",          ## note2: **Correcting State codes
  ...
  stormDat[stormDat$state=="PK",            ## Pacific + Alaskan coastal areas  
           7] <- "AK" 
  stormDat$time_zone <-                     ## note1: *Change time zone 
    toupper(                                ## abbreviation to upper case plain 
      as.character(stormDat$time_zone))     ## text format.
...
1.  _\*Record collection began before Alaska and Hawaii statehood, and time zone
